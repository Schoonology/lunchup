...
/**
 * Returns a TransformStream responsible for adding explicit values to the
 * engine. The same values are passed-through to all reads, allowing chaining
 * with other streams.
 */
LunchUpStream.prototype.values = function values() {
  var self = this

  return through(function (record) {
    self._engine.writeValue(record[0])
